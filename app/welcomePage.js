  ...
  return (
    <View style={styles.mainContainer}>
      ...
      <View style={styles.whiteContainer}>
        ...
        {/* Main Illustration */}
        <Image source={require('../assets/images/people_bags.png')} style={styles.illustration} />

        {/* Main Text Section */}
        <View style={styles.textContainer}>
          <Text style={styles.title}>Let's discover & enjoy the world!</Text>
          <Text style={styles.subtitle}>
            Smartly manage your travel budget ensuring a smooth and enjoyable trip.
          </Text>
        </View>
...
const styles = StyleSheet.create({
  ...
  signUpButton: {
    ...
    paddingHorizontal: width * 0.22, // Même taille que le bouton "Log in"
    borderRadius: 10,
    borderColor: '#1B0E6F',
    borderWidth: 2,
    marginBottom: 6,
