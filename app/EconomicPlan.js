...
//             The economic plan aims to optimize costs by seeking the cheapest solutions for two main expense categories:
...
// //Exemple poour lister les informations qui existes dans la base de donnée
...
// //       try {
// //         const response = await fetch('https://59fc-160-178-242-133.ngrok-free.app/teste/lister.php');
...
// //           console.log('Response text:', text); // Log the text for debugging
// //         }
// //       } catch (error) {
...
// //             ) : (
// //               hotels.map((hotel) => (
// //                 <View key={hotel.id} style={styles.entry}>
// //                 <Image style={styles.imagehouse} source={require('../assets/images/house-placeholder.png')} />
// //                   <View style={styles.info}>
// //                     <Text style={styles.label}><Text style={styles.bold}>Name of hotel:</Text> {hotel.HNom}</Text>
// //                     <Text style={styles.label}><Text style={styles.bold}>Address:</Text> {hotel.Adress}</Text>
// //                     <Text style={styles.label}><Text style={styles.bold}>Type of the bedroom:</Text> {hotel.Tbedroom}</Text>
// //                     <Text style={styles.label}><Text style={styles.bold}>Price:</Text> ${hotel.price}</Text>
// //                   </View>
// //                 </View>
// //               ))
// //             )}
...
// //           {/* Other sections (Houses, Food, etc.) can be added similarly */}
// //         </View>
// //       </ScrollView>
