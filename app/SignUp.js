...
const RegistrationScreen = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.title}>Start the registration</Text>
      {/* Form */}
      <View style={styles.form}>
        ...
        <TextInput style={styles.input} placeholder="Enter the password" secureTextEntry />

        <Text style={styles.label}>Confirm Password</Text>
        <TextInput style={styles.input} placeholder="Confirm the password" secureTextEntry />

        <Text style={styles.label}>Country of Residence</Text>
        <TextInput style={styles.input} placeholder="Confirm your country of residence" />
      </View>

      {/* Confirm Button */}
      <Link href="/SignUpSuc" style={styles.button}>
